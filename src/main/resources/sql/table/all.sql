...
CREATE SEQUENCE SEQ_MEMBER START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_CREW START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_CREW_MEMBER START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_CREW_JOIN_REQUEST START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_ANNOUNCEMENT START WITH 10000 INCREMENT BY 1;
...
(
    ...
    LAT        NUMBER,
    LNG        NUMBER,
    TYPE       VARCHAR2(255) DEFAULT 'PERSONAL' CHECK ( TYPE IN ('PERSONAL', 'ADVERTISE') ),
    STATUS     VARCHAR2(64)  DEFAULT 'APPROVED'
        CHECK ( STATUS IN ('WAIT', 'APPROVED') ),
    CREATED_AT TIMESTAMP WITH TIME ZONE
                             DEFAULT (SYSTIMESTAMP AT TIME ZONE 'Asia/Seoul'),
    CREATED_BY NUMBER REFERENCES MEMBER (MEMBER_ID),
    UPDATED_AT TIMESTAMP WITH TIME ZONE,
...
CREATE SEQUENCE SEQ_FEED START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_MEMBER_WALLET START WITH 10000 INCREMENT BY 1;
...
--     UPDATED_BY  NUMBER REFERENCES MEMBER (MEMBER_ID)
-- );
-- CREATE SEQUENCE SEQ_FEED_URL START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_FEED_COMMENT START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_FEED_LIKE START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_FEED_FILE START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_ANNOUNCEMENT_FILE START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_FOLLOW START WITH 10000 INCREMENT BY 1;
...
--     CREATED_BY       NUMBER REFERENCES MEMBER (MEMBER_ID)
-- );
-- CREATE SEQUENCE SEQ_URL_CLICK_LOG START WITH 10000 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_ACTIVITY_LOG START WITH 10000 INCREMENT BY 1;

-- 16. FEED_VIEW_LOG
CREATE TABLE FEED_VIEW_LOG
(
    FEED_VIEW_LOG_ID NUMBER PRIMARY KEY,
    FEED_ID          NUMBER REFERENCES FEED (FEED_ID),
    CREATED_AT       TIMESTAMP WITH TIME ZONE
        DEFAULT (SYSTIMESTAMP AT TIME ZONE 'Asia/Seoul'),
    CREATED_BY       NUMBER REFERENCES MEMBER (MEMBER_ID),
...
CREATE SEQUENCE SEQ_FEED_VIEW_LOG START WITH 10000 INCREMENT BY 1;

-- 17. KAKAO_PAY
CREATE TABLE KAKAO_PAY
(
    KAKAO_PAY_ID     NUMBER PRIMARY KEY,
    FEED_ID          NUMBER REFERENCES FEED (FEED_ID),
    TID              VARCHAR2(255) UNIQUE,
    PARTNER_ORDER_ID VARCHAR2(255),
    PARTNER_USER_ID  NUMBER REFERENCES MEMBER (MEMBER_ID),
    CHARGE_AMOUNT    NUMBER,
    STATUS           VARCHAR2(64) DEFAULT 'PENDING' CHECK (STATUS IN ('PENDING', 'APPROVED', 'CANCELED', 'EXPIRED') ),
    CREATED_AT       TIMESTAMP WITH TIME ZONE
                                  DEFAULT (SYSTIMESTAMP AT TIME ZONE 'Asia/Seoul'),
    CREATED_BY       NUMBER REFERENCES MEMBER (MEMBER_ID)
);
CREATE SEQUENCE SEQ_KAKAO_PAY START WITH 10000 INCREMENT BY 1;