...
BEGIN
    ...
    VALUES (SEQ_ACTIVITY_LOG.NEXTVAL, 'CREW_JOIN_REQUEST', 'POST', :NEW.CREW_JOIN_REQUEST_ID, SYSDATE, :NEW.CREATED_BY);
END;
/
...
BEGIN
    INSERT INTO ACTIVITY_LOG (ACTIVITY_LOG_ID, TARGET_TABLE_NAME, ACTION, REFERENCE_ID, CREATED_AT, CREATED_BY)
    VALUES (SEQ_ACTIVITY_LOG.NEXTVAL, 'CREW_JOIN_REQUEST', 'UPDATE', :NEW.CREW_JOIN_REQUEST_ID, SYSDATE,
            :NEW.UPDATED_BY);
END;
/
...
BEGIN
    INSERT INTO ACTIVITY_LOG (ACTIVITY_LOG_ID, TARGET_TABLE_NAME, ACTION, REFERENCE_ID, CREATED_AT, CREATED_BY)
    VALUES (SEQ_ACTIVITY_LOG.NEXTVAL, 'CREW_JOIN_REQUEST', 'DELETE', :OLD.CREW_JOIN_REQUEST_ID, SYSDATE,
            :OLD.CREATED_BY);
END;
/